# code taken from https://raw.githubusercontent.com/facebookresearch/fairseq/main/fairseq/data/iterators.py
import itertools
import logging
import math
import operator
...
class EpochBatchIterator(EpochBatchIterating):
    ...
    def __init__(
        ...
        num_workers=0, epoch=1, buffer_size=0, max_iter_len=0, timeout=0
    ):
